...
app.get('/products', passportConfig.isAuthenticated, userController.getProducts);
app.get('/account/subscription', passportConfig.isAuthenticated, userController.getSubscription);
app.post('/account/subscription/subscribe', passportConfig.isAuthenticated, userController.postSubscribeSubscription);
app.post('/account/subscription/cancel', passportConfig.isAuthenticated, userController.postCancelSubscription);
app.post('/account/subscription/switch', passportConfig.isAuthenticated, userController.postSwitchSubscription);
